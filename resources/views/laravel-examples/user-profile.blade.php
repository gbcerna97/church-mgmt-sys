            ...
            <div class="card-body pt-4 p-3">
                <form action="/user-profile" method="POST" role="form text-left">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="mb-3 @error('user.name')border border-danger rounded-3 @enderror">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="mb-3 @error('user.phone')border border-danger rounded-3 @enderror">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn bg-gradient-info btn-md mt-4 mb-4">{{ 'Save Changes' }}</button>
                    </div>
                </form>
